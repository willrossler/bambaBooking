...
const BoxingMobileDetails = () => {
  return (
    <>
      ...
      <p className="descriptionTitleMobile">Styrka och muskler</p>
      <p className="descriptionTextMobile" style={{}}>
        ...
        <br />
        <br /> Även de olika försvarsrörelserna ökar kroppsstyrkan. Detta beror
        på att du behöver hela din kropp för att boxas - din core för att
        stabilisera dig själv, din underkropp och höfter för att svänga och ge
        kraft till slaget, och naturligtvis överkroppen för att ge slaget.
      </p>
      <br />
      <br />
      ...
      <ul className="descriptionTextMobile" style={{ marginBottom: "30px" }}>
        <li>Minskad stress och andra negativa känslor</li>
...
export default BoxingMobileDetails;

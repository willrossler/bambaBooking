...
const MapMobile = () => {
  ...
  const staticMapUrl = `https://maps.googleapis.com/maps/api/staticmap?center=Lützengatan+10,+11520+Stockholm&zoom=17&size=400x400&markers=color:red%7CLützengatan+10,+11520+Stockholm&style=${mapStylesString}&key=REDACTED_GOOGLE_MAPS_KEY`;

          ...
          <Col style={{ paddingRight: "5rem" }} xs={12} md={6}>
            <div>
              ...
              <p className="descriptionText">
                ...
                så effektiv och uppskattad. En del av träningen är
                styrkeintervaller växlat med att slå på en boxningssäck och
                andra tekniska rörelser. Även de olika försvarsrörelserna (även
                om vi inte slår på varandra) ökar hela kroppens styrka. Detta
                beror på att du behöver hela din kropp för att boxas. Att slå
                ett slag korrekt involverar hela kroppen och de flesta
                muskelgrupper. Du behöver din core för att stabilisera dig
                själv, din underkropp och höfter för att svänga och ge kraft
                till slaget, och naturligtvis överkroppen för att ge slaget.
              </p>
              <br />

...
// --- Data för medlemskapssektioner (med all text inkluderad) ---
const membershipSections = [
  {
    title: "BAMBA VIT",
    image: whiteCard,
    imageAlt: "Bamba Vit medlemskort",
    content: (
      <>
  ...
  },
  {
    title: "BAMBA SVART",
    image: blackCard,
    imageAlt: "Bamba Svart medlemskort",
    content: (
      <>
        <p className="descriptionText">
  ...
  },
  {
    title: "BAMBA PT",
    image: PersCard,
    imageAlt: "Personlig träning på Bamba",
    content: (
      <>
        <p className="descriptionText">
  ...
  {
    title: "BAMBA KLIPPKORT",
    image: giftCard,
    imageAlt: "Klippkort på Bamba",
    content: (
      <>
        <p className="descriptionText">
  ...
  {
    title: "BAMBA PRESENTKORT",
    image: ptCard,
    imageAlt: "Presentkort på Bamba",
    content: (
      <>
        <p className="descriptionText">
  ...
  return (
    <>
      ...
      <div style={{ marginTop: "80px" }} className="container">
          ...
          <Col style={{ paddingRight: "5rem" }} xs={12} md={6}>
            <div>
              ...
              <p className="descriptionText">
                ...
                frisk, hel och må bra i sitt liv över tid. Vi vill att du ska
                få en fantastisk träningsupplevelse och att du ska längta
                efter att komma tillbaka till oss för nästa pass.
                <br />
                <br /> Du ser till att ta dig till oss och så ser vi till att
                du har allt du behöver för att träna hos oss helt enkelt.{" "}
                <br />
                <br />
                <strong>
                  <a
        ...
        {/* Mappar och renderar alla medlemskapssektioner från data-arrayen */}
